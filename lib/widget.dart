...
//     paint); // Круг занимает вес размер вкодрата
//  canvas.drawRRect(rect, paint);
//canvas.drawRect(Offset.zero & const Size(30, 30), paint); // Кводрат

// canvas.drawCircle(
//     Offset(size.width / 2, size.height / 2), size.width / 2, paint);  //Квадрат
